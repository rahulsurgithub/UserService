...
import dev.project.userservice.clients.KafkaProducerClient;
import dev.project.userservice.dtos.SendEmailMessageDto;
...
////            return null;
        ...
        //var keyByteArr = Keys.hmacShaKeyFor(key.getBytes(StandardCharsets.UTF_8));

//        "hello".getBytes()

//        String message = "{\n" +
//                "   \"email\": \"rahul.sur@gmail.com\",\n" +
//                "   \"roles\": [\n" +
//                "      \"mentor\",\n" +
//                "      \"ta\"\n" +
//                "   ],\n" +
